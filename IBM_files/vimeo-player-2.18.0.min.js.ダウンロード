...
!(function (e, t) {
  ...
  function h() {
    ...
    if ((f(this, '_id', '_WeakMap_' + m() + '.' + m()), 0 < arguments.length))
    ...
    y =
      ((function (e) {
        ...
        (r = function () {
          ...
          return (
            t((g.prototype = y), '__NPO__', 0, !1),
            t(g, 'resolve', function (n) {
        ...
        return (
          ...
          V.isEnabled &&
            ...
            (this.fullscreenchangeHandler = function () {
              (V.isFullscreen ? b : E)(c, 'event:exitFullscreen', r),
